...
use DBIx::Class::Storage::DBI; # SQL::Abstract::Limit;
use SQL::Abstract;

# 1, 2
{
    my $sql = DBIC::SQL::Abstract->new( limit_dialect => 'LimitOffset' );
    ...
    my $stmt2 = DBIC::SQL::Abstract->new->select("MY_TABLE", "*",   undef, ["id"]);
